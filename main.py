...
#         count = 0
#         for char in phrase:
#             if char == 'а': #работает для одной гласной 'a', можно создать лист гласных и проверять c in
#                 count += 1
#         answer.append(count)
#     check = 0
#     for count in answer:
...
#             check += 1
#
#     print("Парам пам-пам" if check == len(answer) else 'Пам парам')
#
#
# song_text = "пара-ра-рам рам-пам-папам па-ра-па-да"
#
# CheckRythm(song_text)
...
def print_operation_table(operation, num_rows=6, num_columns=6):
    for i in range(1, num_rows + 1):
        ...
        print(''.join(f'{e:2} ' for e in answer))
